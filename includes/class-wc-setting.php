...
{
    public $payxpert_seamless_hash = 'sha384-M9Dgri87tBDqvrhRCh0JnpnvLvsnGLsc0UKffq72bWXUJLJYsy2qLpbPMA2WW1AO';
    public $payxpert_connect2_url = 'https://connect2.payxpert.com';
    public $payxpert_api_url = 'https://api.payxpert.com';
    ...
    if ( $current_section == 'payxpert' ) {
        ...
        $settings_payxpert[] = array(
            ...
            'default' => $this->payment_seemless_hash,
            'type'     => 'text',
        ...
        $settings_payxpert[] = array(
            ...
            'default' => $this->payxpert_connect2_url,
            'type'     => 'text',
